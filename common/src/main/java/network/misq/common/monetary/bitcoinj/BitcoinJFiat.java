...
/**
 * Represents a monetary fiat value. It was decided to not fold this into {@link BitcoinJCoin} because of type
 * safety. Fiat values always come with an attached currency code.
 * <p>
 * This class is immutable.
 */
public final class BitcoinJFiat implements BitcoinJMonetary, Comparable<BitcoinJFiat>, Serializable {
    ...
    private BitcoinJFiat(final String currencyCode, final long value) {
        this.value = value;
        this.currencyCode = currencyCode;
    }

    public static BitcoinJFiat valueOf(final String currencyCode, final long value) {
        return new BitcoinJFiat(currencyCode, value);
    }
     ...
     */
    public static BitcoinJFiat parseFiat(final String currencyCode, final String str) {
        try {
            long val = new BigDecimal(str).movePointRight(SMALLEST_UNIT_EXPONENT).longValueExact();
            return BitcoinJFiat.valueOf(currencyCode, val);
     ...
     */
    public static BitcoinJFiat parseFiatInexact(final String currencyCode, final String str) {
        try {
    ...
    public BitcoinJFiat add(final BitcoinJFiat value) {
        checkArgument(value.currencyCode.equals(currencyCode));
        return new BitcoinJFiat(currencyCode, LongMath.checkedAdd(this.value, value.value));
    }

    public BitcoinJFiat subtract(final BitcoinJFiat value) {
        checkArgument(value.currencyCode.equals(currencyCode));
        return new BitcoinJFiat(currencyCode, LongMath.checkedSubtract(this.value, value.value));
    }

    public BitcoinJFiat multiply(final long factor) {
        return new BitcoinJFiat(currencyCode, LongMath.checkedMultiply(this.value, factor));
    }

    public BitcoinJFiat divide(final long divisor) {
        return new BitcoinJFiat(currencyCode, this.value / divisor);
    }

    public BitcoinJFiat[] divideAndRemainder(final long divisor) {
        return new BitcoinJFiat[]{new BitcoinJFiat(currencyCode, this.value / divisor), new BitcoinJFiat(currencyCode, this.value % divisor)};
    }

    public long divide(final BitcoinJFiat divisor) {
     ...
     * otherwise false.
     */
    public boolean isGreaterThan(BitcoinJFiat other) {
     ...
     * otherwise false.
     */
    public boolean isLessThan(BitcoinJFiat other) {
        return compareTo(other) < 0;
    }
    ...
    public BitcoinJFiat negate() {
        return new BitcoinJFiat(currencyCode, -this.value);
    }
    ...
    public boolean equals(final Object o) {
        ...
        final BitcoinJFiat other = (BitcoinJFiat) o;
    ...
    @Override
    public int compareTo(final BitcoinJFiat other) {
