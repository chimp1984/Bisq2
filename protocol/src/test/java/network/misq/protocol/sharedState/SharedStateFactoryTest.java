...
import static network.misq.protocol.SecurityProvider.Unit.UNIT;
import static network.misq.protocol.sharedState.SharedStateFactory.fireEvent;
import static network.misq.protocol.sharedState.SharedStateFactory.when;
