...
import static network.misq.finance.contract.SecurityProvider.Unit.UNIT;
import static network.misq.finance.contract.sharedState.SharedStateFactory.fireEvent;
import static network.misq.finance.contract.sharedState.SharedStateFactory.when;
