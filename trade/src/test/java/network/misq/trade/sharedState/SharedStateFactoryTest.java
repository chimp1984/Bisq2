...
import static network.misq.contract.SecurityProvider.Unit.UNIT;
import static network.misq.trade.sharedState.SharedStateFactory.fireEvent;
import static network.misq.trade.sharedState.SharedStateFactory.when;
