...
package network.misq.network.data.storage.auth;
...
import network.misq.network.data.storage.mailbox.AddMailboxRequest;
import network.misq.network.data.storage.mailbox.DataStore;
import network.misq.network.data.storage.mailbox.MailboxData;
import network.misq.network.data.storage.mailbox.MailboxPayload;
