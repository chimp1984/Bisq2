...
@Slf4j
public class I2PNodeRepositoryTest extends BaseNodeRepositoryTest {
    ...
    private static final NodeConfig nodeConfig = new NodeConfig(NetworkType.I2P,
            Set.of(NetworkType.I2P),
